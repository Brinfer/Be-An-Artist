...
public class ActionEffacerTout extends AbstractAction {
	/**
	 ...
	 * @since 0.3.4.5
	 */
	public ActionEffacerTout(final PanneauDessin panneauDessin) {
		super(ActionEffacerTout.NOM_ACTION);
	...
	public void actionPerformed(final ActionEvent event) {
		final int choix = JOptionPane.showConfirmDialog(this.panneauDessin, "Voulez-vous supprimer le dessin?",
				ActionEffacerTout.NOM_ACTION, JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
