...
import fr.eseo.poo.projet.artiste.modele.EpaisseurTrait;
 ...
 * <li>L'épaisseur du trait est initialisé à
 * {@value #EPAISSEUR_TRAIT_DEFAUT}.</li>
 * </ul>
 * Il est possible de déterminer les coordonnées des autres coins du rectangles.
 * <p>
 * Une {@code Forme} peut être coloré, et avoir une épaisseur de trait
 * différentes.
 * 
 * @see Coordonnees
 * @see Coloriable
 ...
 * @version 0.4.4.1
 */
public abstract class Forme implements Coloriable, EpaisseurTrait {
    ...
    /**
     * Valeur {@code Color} par défaut de l'épaisseur du trait de la forme.
     * 
     * @since 0.4.4.1
     */
    public static final float EPAISSEUR_TRAIT_DEFAUT = 1.0f;
    ...
    /**
     * Attribut représentant l'épaisseur du trait de la forme.
     * <p>
     * Cette épaisseur est modifiable.
     * <p>
     * Initialisé par défaut à {@valeu #EPAISSEUR_TRAIT_DEFAUT}.
     * 
     * @see #EPAISSEUR_TRAIT_DEFAUT
     * @see EpaisseurTrait#getEpaisseurTrait()
     * @see EpaisseurTrait#setEpaisseurTrait(float)
     * 
     * @since 0.4.4.1
     */
    ...
    public Forme(final Coordonnees position, final double largeur, final double hauteur) {
        ...
        this.epaisseurTrait = Forme.EPAISSEUR_TRAIT_DEFAUT;
    }
    ...
    public void deplacerDe(final double deltaX, final double deltaY) {
        this.setPosition(
                new Coordonnees(this.getPosition().getAbscisse() + deltaX, this.getPosition().getOrdonnee() + deltaY));
    }
     ...
     * {@inheritDoc}
     * 
     * @return Une {@code Color} correspondant à la couleur de la forme.
     * 
     * @since 0.3.5.1
     */
    @Override
     ...
     * {@inheritDoc}
     * 
     * @param couleur Une {@code Color} correspondant à la nouvelle couleur de la
     *                forme.
     * 
     * @since 0.3.5.1
     */
     ...
     * {@inheritDoc}
     * 
     * @param epaiseur Un {@code float} correspondant à la nouvelle epaisseur du
     *                 trait.
     * 
     * @since 0.4.4.1
     */
    @Override
    public void setEpaisseurTrait(final float epaisseur) {
     ...
     * {@inheritDoc}
     * 
     * @return Un {@code float} correspondant à l'epaisseur du trait.
     * 
     * @since 0.4.4.1
     */
    @Override
     ...
     * <p>
     * La description est de la forme:
     * {@code  epaisseur du trait = <epaisseurDuTrait>}
     * <p>
     * 
     * @since 0.4.4.1
     */
    ...
    public String descriptionEpaisseurTrait() {
        ...
        return " epaisseur du trait : " + formater.format(this.getEpaisseurTrait());
    }
