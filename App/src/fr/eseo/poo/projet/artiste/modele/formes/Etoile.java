...
public class Etoile extends Forme implements Remplissable {
     ...
     * @since 0.3.7.1
     */
    private boolean estPointDeEtoile(final Coordonnees point) {
     ...
     * @since 0.3.7.1
     */
    public Coordonnees[] getCoordonneesTriangleBranche(final int indiceBranche) {
        final Coordonnees[] tab = new Coordonnees[3];
     ...
     * {@inheritDoc}
     * <p>
     * Le déplacement de la position de l'étoile implique un recalcule de la
     * position des sommets de l'étoile.
     * 
     ...
     * {@inheritDoc}
     * 
     * @param modeRemplissage Un {@code boolean} indiquant si l'on souhaite que la
     *                        forme soit rempli.
     * 
     * @since 0.3.7.1
     */
     ...
     * {@inheritDoc}
     * 
     * @return Un {@code double} correspondant au périmètre de l'étoile.
     * 
     * @since 0.3.7.1
     */
    @Override
    ...
    public boolean contient(final Coordonnees point) {
        ...
        for (int i = 0; i < this.getNombreBranches(); i++) {
            ...
            for (int j = 0; j < 3; j += 2) {
                final Coordonnees sommetPoly = coordonneesTriangle[j];
    ...
    /**
     * Fonction renvoyant une description de l'étoile sous la forme :
     * <p>
     * {@code [Etoile<-Rempli>] pos : (<abscisse>), <ordonnée>) dim <largeur> x <hauteur> 
     * périmètre : <perimetre> aire : <aire>, couleur = <couleur RGB> epaisseur du trait : <epaisseurDuTrait}.
     * 
    ...
    public boolean equals(final Object other) {
        ...
        final Etoile etoile = (Etoile) other;
