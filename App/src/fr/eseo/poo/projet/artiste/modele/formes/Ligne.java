...
public class Ligne extends Forme {
	 ...
	 * <ordonnée>) longueur : <longeur> angle : <angle>, couleur <code couleur RGB>}.
	 * 
	...
	public String toString() {
		...
		return '[' + getClass().getSimpleName() + "] c1 : " + this.getC1().toString() + " c2 : "
				...
				+ formater.format(angle) + '°' + super.descriptionCouleur();
	}
	...
	@Override
	public int hashCode() {
		return super.hashCode() + super.descriptionCouleur().hashCode();
	}
}